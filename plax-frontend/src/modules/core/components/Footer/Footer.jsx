        ...
        <footer className='footer'>
            <Link to='/'>
                <figure className='footer__isologo'>
                    ...
                    <figcaption>Integrantes del Grupo: Yufra, Marcelo Alejandro 4308 -  Barboza, Gonzalo Nicolás 4667 - Yáñez, Sofia Trinidad 4471 - Guerrero Erazo Luis Alberto 4509 - Véliz, Guadalupe Virginia 4317</figcaption>
                </figure>
            </Link>
        </footer>
    )
